...
#ifndef ROMAM_TCP_APPLICATION_HELPER_H
#define ROMAM_TCP_APPLICATION_HELPER_H
 ...
 * on a set of nodes.
 */
class RomamTcpAppHelper
{
  public:
    /**
     * Create an RomamTcpAppHelper to make it easier to work with BulkSendApplications
     *
     ...
     *        to.
     */
    RomamTcpAppHelper(std::string protocol, Address address);
...
#endif /* ROMAM_TCP_APPLICATION_HELPER_H */