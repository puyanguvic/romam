 ...
 */
class DDRHelper : public Ipv4RoutingHelper
{
  public:
    /**
     ...
     *
     * \brief This method create the DDRv2 QueueDisc (along with it's internal queues,
    ...
    /**
     * This method intall DDRv2Queue into NetDevice
     */
  ...
  private:
     ...
     * \return
     */
    DDRHelper& operator=(const DDRHelper&);
};
