...
#ifndef ROMAM_APPLICATION_HELPER_H
#define ROMAM_APPLICATION_HELPER_H
...
class RomamApplicationHelper
{
  public:
     ...
     *
     */
    RomamApplicationHelper(std::string protocol, Address address);

    ~RomamApplicationHelper();
...
#endif /* DGR_APPLICATION_HELPER_H */