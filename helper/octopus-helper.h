...
#ifndef OCTOPUS_HELPER_H
#define OCTOPUS_HELPER_H
 ...
 */
class OctopusHelper : public Ipv4RoutingHelper
{
  public:
    /**
     ...
     */
    OctopusHelper(const OctopusHelper&);
  ...
  private:
     ...
     * \return
     */
    OctopusHelper& operator=(const OctopusHelper&);
};

} // namespace ns3

#endif /* OCTOPUS_HELPER_H */
