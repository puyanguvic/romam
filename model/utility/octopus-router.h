...
#ifndef OCTOPUS_ROUTER_H
#define OCTOPUS_ROUTER_H
 ...
 */
class OctopusRouter : public RomamRouter
{
  public:
    /**
  ...
  private:
    ~OctopusRouter() override;

    Ptr<OctopusRouting> m_routingProtocol; //!< the Ipv4GlobalRouting in use
     ...
     */
    OctopusRouter(OctopusRouter& sr);
     ...
     */
    OctopusRouter& operator=(OctopusRouter& sr);
};

} // namespace ns3

#endif /* OCTOPUS_ROUTER_H */
