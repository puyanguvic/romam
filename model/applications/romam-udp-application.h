...
#ifndef ROMAM_UDP_APPLICATION_H
#define ROMAM_UDP_APPLICATION_H
...
class RomamUdpApplication : public Application
{
  public:
    RomamUdpApplication();
    ~RomamUdpApplication() override;
