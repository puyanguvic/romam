 ...
 * somewhere in the node, so therefore this class RomamRouting
...
class RomamRouting : public Ipv4RoutingProtocol
{
  public:
    ...
    /**
     * \brief Construct an empty RomamRouting routing protocol,
     *
     ...
     *
     * \see Ipv4RoutingTableEntry
     * \see RomamRouting::GetRoute
     * \see RomamRouting::AddRoute
     */
