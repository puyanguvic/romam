...
#ifndef SPF_ALGORITHM_H
#define SPF_ALGORITHM_H
...
class SPFAlgorithm : public RoutingAlgorithm
{
  public:
    SPFAlgorithm();
    virtual ~SPFAlgorithm();

    // Delete copy constructor and assignment operator to avoid misuse
    SPFAlgorithm(const SPFAlgorithm&) = delete;
    SPFAlgorithm& operator=(const SPFAlgorithm&) = delete;
