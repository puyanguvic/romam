...
public:
   ...
   */
  Ipv4RouteInfoEntry (Ipv4RouteInfoEntry const &route);
  /**
   * \brief Copy Constructor
   * \param route The route to copy
   */
  ...
  */
   ...
   * \param interface Outgoing interface 
   */
  static Ipv4RouteInfoEntry CreateDefaultRoute (Ipv4Address nextHop, 
                                                   uint32_t interface);
...
private:
   ...
   * \param interface the interface index
   */
  Ipv4RouteInfoEntry (Ipv4Address dest,
                         Ipv4Mask mask,
                         uint32_t interface);
  /**
   * \brief Constructor.
